  ...
  return (
    <section id="vip" className="py-16 md:py-24 px-4 md:px-6 bg-[#080808] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start">
          {tiers.map((tier, i) => (
            <motion.div
              ...
              className={`relative p-6 md:p-8 rounded-2xl border ${tier.border} bg-black/40 backdrop-blur-sm border-white/10 hover:border-[#BF953F]/50 md:hover:-translate-y-2 transition-all duration-500 group`}
            >
              {tier.popular && (
        ...
        {/* CHECK POINTS STRIP - FIXED INPUT ZOOM */}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
              <div className="relative w-full sm:w-64 md:w-48">
                <input 
                  ...
                  /* CRITICAL FIX: 
                     text-base (16px) on mobile stops the browser zoom.
                     md:text-xs (12px) restores the small look on desktop.
                  */
