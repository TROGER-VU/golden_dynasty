...
const CTASection = () => (
  ...
  >
    <a href="https://wa.me/917347747675" target="_blank" rel="noopener noreferrer" className="group relative px-12 py-5 bg-gold-metallic text-black font-bold uppercase tracking-[0.2em] text-xs transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(191,149,63,0.4)]">
      Join the Club
    </a>
