...
export default function Hero() {
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          {/* Use your 10-second slow-mo shuffle video here */}
  ...
  {['♠', '♥', '♣', '♦'].map((suit, index) => (
    <motion.span
      ...
      style={{ filter: "drop-shadow(0 0 8px rgba(191,149,63,0.3))" }}
    >
      {suit}
    </motion.span>
  ))}
      ...
      >
        <span className="text-[10px] text-white uppercase tracking-[0.3em]">The Arena</span>
