      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
             ...
             <div>
               <h5 className="text-white font-serif font-black tracking-widest text-lg leading-none">GOLDEN</h5>
          ...
          <div className="flex gap-4">
            {[
              ...
              { name: "Facebook", path: "M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1V12h3l-.5 3H13v6.8c4.56-.93 8-4.96 8-9.8z" },
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-500">
            <li className="hover:text-[#BF953F] cursor-pointer transition-colors">Live Table Status</li>
            <li className="hover:text-[#BF953F] cursor-pointer transition-colors">Tournament Calendar</li>
            <li className="hover:text-[#BF953F] cursor-pointer transition-colors">VIP Membership</li>
            <li className="hover:text-[#BF953F] cursor-pointer transition-colors">House Rules</li>
          </ul>
        </div>
    ...
    <li className="flex gap-4 group items-center">
      ...
      <span className="group-hover:text-gray-300 transition-colors">
        ...
        <div className="bg-[#111] p-6 rounded-sm border border-white/5">
          <p className="text-[#BF953F] text-[10px] uppercase tracking-widest font-bold mb-3">Director & Visionary</p>
          <p className="text-white font-serif italic mb-2">We didn&apos;t build a house of cards. We built an arena for the intellect.</p>
          <p className="text-gray-500 text-xs text-right">— Akash Swarnkar</p>
        </div>
      </div>

      {/* 3. COPYRIGHT & SEO STRIP */}
