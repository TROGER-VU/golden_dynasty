        ...
        <div>
          ...
          <ul className="space-y-6 text-[13px] text-gray-500">
            ...
            <li className="flex gap-4 group items-center">
              ...
              <span className="group-hover:text-gray-300 font-mono transition-colors">+91 73477 47675 </span>
            </li>
            {/* Email */}
            <li className="flex gap-4 group items-center">
              <div className="text-[#BF953F] group-hover:scale-110 transition-transform duration-300">
              ...
              <span className="group-hover:text-gray-300 font-mono transition-colors">hr@thegoldendynasty.club</span>
            </li>
          </ul>
        </div>
