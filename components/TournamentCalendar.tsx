...
type TabType = "upcoming" | "results" | "series";
...
// Mapping from tab label to TabType
...
export default function TournamentCalendar() {
  ...
  return (
    <section
      id="tournaments"
      className="py-14 px-6 bg-[#020202] border-t border-white/5 relative"
    >
      {/* Background Decor */}
            ...
            >
              ...
              <div className="flex-1 p-6 md:pl-10 text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8 text-sm text-gray-400">
                  ...
                  <span className="flex items-center gap-2 justify-center md:justify-start">
                    <span className="text-[#BF953F]">💰</span> Buy-in:{" "}
                    <span className="text-white font-bold">{event.buyin}</span>
                  </span>
                </div>
              </div>
              ...
              <div className="w-full md:w-auto p-6 flex flex-col items-center gap-3 border-t md:border-t-0 md:border-l border-white/10 bg-[#050505]">
                ...
                <button
                  ...
                  disabled={event.status === "Waitlist"}
                >
